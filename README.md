...
| [VIKINGYFY/nss-packages-618](https://github.com/VIKINGYFY/nss-packages-618) | OpenWrt feed (NSS 包 6.18 兼容版,immortalwrt-nss feeds + NSS workflow 使用) | pin `1306d122` (✅ 已验证) | ✓ |
| [VIKINGYFY/nss-packages](https://github.com/VIKINGYFY/nss-packages) | OpenWrt feed (NSS 包,sync-check 监控,与 -618 同 HEAD) | branch `NSS-12.5-K6.x` | ✓ |

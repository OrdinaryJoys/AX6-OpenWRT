...
# ---------------------------------------------------------------------------
# Scratch source tree with five Makefiles
# ---------------------------------------------------------------------------
mk_tree() { # hostapd_release drv_release ecm_release clients_release mcs_release [dup_flag]
    tree="$tmp/tree"
    rm -rf "$tree"
...
mk_lock() { # hostapd drv ecm clients mcs
    lock="$tmp/lock.env"
    {

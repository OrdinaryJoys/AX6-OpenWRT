...
| `28625314496` | `codex/ax6-p2f-stock-nvmem-build-validation` | `codex/ax6-stock-nvmem-candidate` / `aa5ee57c3b11d4321c6617683617cf9443d78518` | 成功: AX6 stock nvmem 子集单独 stock 构建和最终 rootfs 检查均通过 |
...
| P2f | 官方 AX6 stock nvmem 子集 | 源码候选 `codex/ax6-stock-nvmem-candidate`;AX6 验证分支 `codex/ax6-p2f-stock-nvmem-build-validation` | 单独 stock 构建 `28625314496` 完整通过 | 仍需确认 stock layout/nvmem/caldata 实机运行影响后才考虑合入主线 |
